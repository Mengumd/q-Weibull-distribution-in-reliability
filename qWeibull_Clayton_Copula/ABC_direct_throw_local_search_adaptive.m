...
max_eta = mean(lifes);
% ub=[1 1 max_eta]; %/*lower bounds of the parameters. */
% lb=[0.8 0.2 0.0001];%/*upper bound of the parameters.*/
% ub=[1.9 10 max_eta]; %/*lower bounds of the parameters. */
% lb=[-10 0.00001 0.0001];%/*upper bound of the parameters.*/
ub=[0.9495 0.566 15.2]; %/*lower bounds of the parameters. */
lb=[0.9493 0.561 14.8];%/*upper bound of the parameters.*/
% ub=[1.9 2 20]; %/*lower bounds of the parameters. */
% lb=[0.1 0.1 10];%/*upper bound of the parameters.*/
