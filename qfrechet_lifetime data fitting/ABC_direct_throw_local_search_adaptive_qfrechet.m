function [GlobalMins,solutions, plotOutPut]=ABC_direct_throw_local_search_adaptive_qfrechet(isLocalAdded)
...
global lifes;
if ( sol(1) < 2 && sol(2) > 0 && sol(3) > 0 && min((1-((1-sol(1))/(2-sol(1)))*(lifes/sol(3)).^(-sol(2))))>0 )
    b = 1;
else
    b = 0;
end
